...
sys.path.insert(0, os.path.abspath('../pecg/'))
#os.path.join('pe')
print(sys.path)
...
latex_documents = [
    (master_doc, 'pecg.tex', 'pecg Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'pecg', 'pecg Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pecg', 'pecg Documentation',
     author, 'pecg', 'One line description of project.',
     'Miscellaneous'),
]
