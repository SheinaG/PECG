...
sys.path.insert(0, os.path.abspath('../pebm/'))
#os.path.join('pe')
print(sys.path)
...
latex_documents = [
    (master_doc, 'pebm.tex', 'pebm Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'pebm', 'pebm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pebm', 'pebm Documentation',
     author, 'pebm', 'One line description of project.',
     'Miscellaneous'),
]
